package rabbitmq.consumer.confirm.rabbitmqconsumerconfirm.config;
...
public class RabbitConfig {
    ...
    public static class DirectExchangeDemoConfiguration {
        ...
        public Binding demo01Binding() {
            return BindingBuilder.bind(demo01Queue()).to(demo01Exchange()).with(Demo12Message.ROUTING_KEY);
        }
    }
}
